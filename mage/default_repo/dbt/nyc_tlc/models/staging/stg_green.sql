...
with src as (
  select
    ...
    /* green NO tiene airport_fee -> forzamos null para alinear con yellow */
    cast(null as float)                     as airport_fee,

    /* green SÍ puede tener CBD_CONGESTION_FEE: si existe en BRONZE lo casteamos; si no, deja null */
